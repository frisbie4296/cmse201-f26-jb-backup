...
1. Go to the Anaconda Download webpage: [https://www.anaconda.com/download/success](https://www.anaconda.com/download/success) **NOTE: You do not need to provide your email address or create an account. You also should avoid using Anaconda Cloud -it is not powerful enoughfor this class!**

2. Make sure you are dowloading the Anaconda (not Miniconda)installer for the appropriate operating system (Windows | macOS | Linux) for your computer (it may auto-detect the correct operating system).
