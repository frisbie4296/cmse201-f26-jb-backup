...
* Narrative text (using Markdown cells) that explains what you did, why you did it, and how you went about it. You should break the notebook up into the following meaningful sections so that the instructor can follow the logical flow of your work:
 ...
 - 	- **Data Or Algorithm Context**: Provide some context for the problem and what question(s) you set out to answer.
...
* The **context** of your data or algorithm.
...
* Peer assessment (**10 points**). You will submit peer assessments for your colleagues and be graded on the quality of your feedback (out of 10).	
