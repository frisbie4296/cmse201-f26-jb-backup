...
# # Day 20 Pre-Class: 2D NumPy Arrays
...
# &#9989;&nbsp; **Task:** What are the values of each of the cars in our dataset in terms of **British Pounds (£)**? When this assignment was written, $£ 1 \approx \$ 0.85$. You should round your answers to _the nearest pound_ using `np.round()` function!
