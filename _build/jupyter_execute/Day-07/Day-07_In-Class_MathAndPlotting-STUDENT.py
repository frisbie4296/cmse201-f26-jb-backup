...
# 
# You and your groups members are expected to work this out **together using a whiteboard**. For virtual students, **use a virtual whiteboard (e.g. [Google Jamboard](https://jamboard.google.com/)**.
# 
