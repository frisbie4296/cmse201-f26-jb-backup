...
# # Day 21 Pre-Class: 2D NumPy Arrays
...
# &#9989;&nbsp; **Task:** _In your own words_, explain the idea of a 2D array to a friend who has never coded before. Why do we call it a **2D** array? Can you think of an example other than the examples outlined in the videos where 2D arrays could prove to be useful? 
...
# &#9989;&nbsp; **Task:** Two of the five ships have been placed on the board for you. **Use 2D indexing to place the remaining ships on the board and verify that the placement matches the image using the `plt.imshow` command.**
...
# &#9989;&nbsp; **Task:** Explain how our dataset is now represented as a Numpy array. How is a row of information in the table represented in the 2D array? How is a column represented? Does this differ from a Pandas dataframe? This is an exercise in explaining where the data is stored and what it looks like in our code!
...
# &#9989;&nbsp; **Task:** How does this code remind you of the way we retreived information from dataframes in Pandas? 
...
# &#9989;&nbsp; **Task:** What are the values of each of the cars in our dataset in terms of **British Pounds (£)**? When this assignment was written, $£ 1 \approx \$ 1.18$. You should round your answers to _the nearest pound_ using `np.round()` function!
...
# &#9989;&nbsp; **Task:** Write code to display only the data for cars that have an engine horsepower greater than or equal to 300 HP. There a couple of ways that you can do this. Are you going to use a loop to do this? Are you going to select the indexes by hand? Something else?
...
# &#9989;&nbsp; **Task:** Explain the concept of "masking" to someone who hasn't coded before. Why might we want to use masking? Is it always the right choice for selecting subsets of our data or parts of our arrays?
...
# &#9989;&nbsp; **Question:** Using `.shape` or `len`, how many different cars are in this dataset? What challenges does this pose when trying to select portions of the data for analysis? 
...
# #### Using Masking for Filtering Data
# 
...
# 
# Here is an image to help you visualize the array structure of an image!
# 
...
# We are going to be working with code like this in class, so make sure you understand what the above lines all do and come to class with questions or submit them in your pre-class survey!
