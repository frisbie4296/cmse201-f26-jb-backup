...
# 
# ![picture](https://static01.nyt.com/newsgraphics/2021/05/24/chicago/a2fcf9e876edbc083fd69ac91ffd4a3a1ccde852/threat.jpg)
# 
...
# * `lake_ontario.csv`
# 
# These files are given with this notebook on D2L. You will read data from those files and it is important that the files are in the same place as the Jupyter notebook on your computer. Work with other members of your group to be sure everyone knows where the files are. 
# 
...
mhu_date, mhu_level = np.loadtxt("lake_michigan_huron.csv", usecols = [0,1], unpack=True, delimiter=',') # example for the mhu.csv file
...
# <font size="+3">&#9998;</font> In the data I see....
