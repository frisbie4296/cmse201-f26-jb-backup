...
# 
# $$\frac{dv_{\mathrm{spring}}}{dt} = \frac{-k~\Delta l}{m}$$
# 
# where 
# 
# 1. **The displacement, $\Delta l$, is defined to be $\Delta l = l - l_{\mathrm{unstretched}}$**, where $l_{\mathrm{unstretched}}$ is the natural length of the spring when it is neither stretched or compressed.
...
# - A mass, $m$, of 80 kg
# - Assume that $l=0$ and that this represents the time when the bungee jumper is at their highest point (i.e., right before they jump)
# - Finally, use 0.1 seconds as your initial time step size ($dt$), and run your model for a total of 60 seconds.
