...
# # Day 15 In-class: Building Compartmental Models
# ___
# 
...
# * A picture of each of the three compartmental models. **You can draw these on some sort of virtual whiteboard or other collaborative app** and save a picture. You can choose the platform that works best for your group!
...
from IPython.display import YouTubeVideo
YouTubeVideo('yp9YKEO9e1w',width=640,height=360,end=129)
