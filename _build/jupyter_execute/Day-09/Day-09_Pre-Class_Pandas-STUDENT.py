...
# # Day 9 Pre-class Assignment: Computational Models Overview and The Pandas Data Analysis Library
# 
...
# &#9989;&nbsp; **Question 1:**  In your own words, decribe what scientific models do.

# <font size="+3">&#9998;</font> *Put your answer here*

# &#9989;&nbsp; **Question 2:** What are some of the limitations of scientific models?
...
# ### Video 2
# 
# This video introduces plotting dataframes using the Pandas module. Pandas does have its own plotting functions which you may see referenced from time to time. You are welcome to explore them and use them, but in CMSE 201, we will focus on using Pandas (or numpy) for loading and analyzing data and Matplotlib for visualizing the data!
# 
...
# &#9989;&nbsp; **Question 1:**  Using `matplotlib.pyplot`, make a histogram of the resting blood pressure of the patient upon admission, with a title indicating what you're looking at.  
...
# 
# &#9989;&nbsp; __Question 1__: Access information in the second column of Example_Dataframe. 
...
# &#9989;&nbsp; **Question 2:** We access the information in the second row in a similar manner. 
...
# 
# &#9989;&nbsp; **Question 3**: Access the top left element of the Example_Dataframe.
