...
## Grading
Your grade on the Code Portfolio assignment will be based on the two check-ins. We expect you to be thoughtful about what code you add to your portfolio and provide clear explanations that another student could understand. As long as you put an honest effort into creating your code portfolio, you should have no problem getting the points for this assignment. You should include at least one item per day of class (i.e. items for days 1-12 for checkpoint 1 and items for days 1-24 for checkpoint 2), but you are welcome to add as many items as is helpful for you beyond that! You will submit your notebook via CodeGrade for grading, but you are encouraged to keep a local copy that you can access after the conclusion of CMSE 201!
